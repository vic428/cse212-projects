...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Actual queue order starts with Sue instead of Bob, causing mismatch at first step.
    ...
    // Defect(s) Found: Actual output mismatched from start: Sue appears where Bob was expected after first step.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Actual output starts with Sue instead of Bob; infinite-turn handling appears to rotate incorrectly.
    ...
    // Defect(s) Found: Actual output starts with Sue instead of Tim, then diverges in early sequence.
